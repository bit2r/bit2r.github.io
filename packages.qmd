...
#### BitWriter — AI 글쓰기 워드프로세서

인공지능과 함께 쓰는 글쓰기 워드프로세서를 개발하고 있습니다. (개발 중) — [GitHub](https://github.com/bit2r/BitWriter/)
:::
::: {.link-card}
[{{< fa language >}}]{.lc-ico}
...
한글 처리를 지원하는 도구입니다. — [GitHub](https://github.com/bit2r/BitHangul)
:::
:::
