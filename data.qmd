...
table_data$로고 <- str_glue("<img src='{table_data$로고}' style='height:80px; width:auto;'>")

# Create the gt table
pkg_gt <- table_data |>
  select(로고, pkg_name, 데이터_패키지_설명) |>
  gt() |>
    cols_label(
      로고 = "로고",
      pkg_name = "패키지명",
    ...
    cols_align(align = "center", columns = c(로고, pkg_name)) |>
    cols_align(align = "left", columns = 데이터_패키지_설명) |>
    tab_options(
      table.width = pct(100),
